...
public class InformationPointStoreFactory {
    ...
    private InformationPointStoreFactory() {
    }

    public static InformationPointStore create(InformationPointStoreConfiguration configuration) {
        if (configuration.isPersistenceEnabled()) {
            return new FileStore(configuration.getStoreFilePath());
        } else {
