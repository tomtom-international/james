...
public abstract class AbstractFullJames implements James {
    private long sleepTime = 1000;
    private Queue<JamesObjective> objectives;
    private static final Logger LOG = Logger.getLogger(AbstractFullJames.class);

    public AbstractFullJames(Queue<JamesObjective> objectives, long sleepTime) {
